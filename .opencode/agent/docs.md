---
description: "Documentation Writer - Use PROACTIVELY para README, documentação de API, diagramas e guias técnicos."
---
...
> Fonte: `agents/docs-agent.json` · Gerado pelo Izanagi AI (`izanagi export --cli opencode`)
