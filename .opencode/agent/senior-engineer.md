---
description: "Senior Engineer - Use PROACTIVELY para implementação full-stack de ponta a ponta com TDD estrito."
---
...
> Fonte: `agents/senior-engineer-agent.json` · Gerado pelo Izanagi AI (`izanagi export --cli opencode`)
