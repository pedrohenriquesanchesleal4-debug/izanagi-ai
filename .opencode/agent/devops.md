---
description: "DevOps Engineer - Use PROACTIVELY para CI/CD, Docker, Kubernetes, IaC e observabilidade."
---
...
> Fonte: `agents/devops-agent.json` · Gerado pelo Izanagi AI (`izanagi export --cli opencode`)
