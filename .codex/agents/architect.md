...
**Arquiteta sistemas com trade-offs explícitos, ADRs, planos de implementação e JIT de complexidade**
...
> Fonte: `agents/architect-agent.json` · Gerado pelo Izanagi AI
