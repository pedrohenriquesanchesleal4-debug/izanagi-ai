...
> **Ver também:** `skills/handoff-sessao/SKILL.md` cobre boa parte deste domínio no formato novo (SKILL.md). Este arquivo mantém foco em recuperação de contexto entre sessões, não coberto lá em detalhe.
