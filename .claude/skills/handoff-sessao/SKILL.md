...
## Quando acionar
- Usuário indica que vai parar/continuar depois. - A tarefa está pela metade (ex. feature com 3 de 5 passos feitos). - O contexto da conversa está grande e prestes a ser resumido/perdido.
## O que gravar
...
> Gerado pelo Izanagi AI — resumo da skill original `skills/handoff-sessao/SKILL.md`.
