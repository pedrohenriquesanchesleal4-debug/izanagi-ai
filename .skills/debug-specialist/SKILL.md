...
description: "Protocolo de primeira resposta a erros: captura contexto, reproduz, isola a causa e descarta causas comuns (cache, config, ambiente) antes de escalar. Use ao investigar um erro, stack trace ou bug reportado. Gatilhos de ativação: skill: debug specialist; identity; goals; triggers."
version: 2.0.0
...
> Migrado deterministicamente de `skills/debug-specialist/SKILL.md` (v1) pelo skill-migrator (ADR-004). Corpo original preservado íntegro em **Legacy Reference (v1)**.

## Triggering Criteria

- **Domínio:** Engenharia (`engineering`)
- **Resumo:** Protocolo de primeira resposta a erros: captura contexto, reproduz, isola a causa e descarta causas comuns (cache, config, ambiente) antes de escalar.
- **Ativar quando:** Use ao investigar um erro, stack trace ou bug reportado.
- **Escopo canônico:** Skill: Debug Specialist
- **Seções do corpo original:** Identity · Goals · Triggers · Debug Protocol · Error Pattern Library
...
### Passo 4 — RULE OUT COMMON CAUSES
