...
description: "Use após criar uma classe ou antes de refatorar para validar aderência aos 5 princípios SOLID, com violações e sugestões de correção. Gatilhos de ativação: skill: solid validator; identity; goals; triggers."
version: 2.0.0
...
> Migrado deterministicamente de `skills/solid-validator/SKILL.md` (v1) pelo skill-migrator (ADR-004). Corpo original preservado íntegro em **Legacy Reference (v1)**.

## Triggering Criteria

- **Domínio:** Engenharia (`engineering`)
- **Resumo:** Use após criar uma classe ou antes de refatorar para validar aderência aos 5 princípios SOLID, com violações e sugestões de correção.
- **Ativar quando:** Use após criar uma classe ou antes de refatorar para validar aderência aos 5 princípios SOLID, com violações e sugestões de correção.
- **Escopo canônico:** Skill: SOLID Validator
- **Seções do corpo original:** Identity · Goals · Triggers · SRP — Single Responsibility Principle · OCP — Open/Closed Principle
...
### Passo 1 — The SOLID Validator checks every class and module against the five SOLID principles.
