---
name: "qa"
description: "Use para auditar código antes de merge/deploy: TypeScript estrito, React, performance, acessibilidade WCAG, responsividade, segurança, SEO e pirâmide de testes. Gatilhos de ativação: quality assurance — manual operacional; quando usar; pirâmide de testes; dimensão 1: typescript strict."
version: 2.0.0
category: testing
tools:
  mcp:
...
> Migrado deterministicamente de `skills/qa/SKILL.md` (v1) pelo skill-migrator (ADR-004). Corpo original preservado íntegro em **Legacy Reference (v1)**.

## Triggering Criteria

- **Domínio:** Testes & QA (`testing`)
- **Resumo:** Use para auditar código antes de merge/deploy: TypeScript estrito, React, performance, acessibilidade WCAG, responsividade, segurança, SEO e pirâmide de testes.
- **Ativar quando:** Use para auditar código antes de merge/deploy: TypeScript estrito, React, performance, acessibilidade WCAG, responsividade, segurança, SEO e pirâmide de testes.
- **Escopo canônico:** Quality Assurance — Manual Operacional
- **Seções do corpo original:** Quando usar · Pirâmide de Testes · Dimensão 1: TypeScript Strict · Dimensão 2: Componentes React · Dimensão 3: Performance
...
### Passo 2 — Template de Review (5 dimensões)
