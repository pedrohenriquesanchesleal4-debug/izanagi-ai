---
name: "web-perf-seo"
description: "Otimiza Core Web Vitals (LCP, CLS, INP), assets, cache e SEO on-page (meta tags, structured data) com metas de Lighthouse. Use ao criar páginas, otimizar performance ou auditar SEO. Gatilhos de ativação: web performance & seo — manual operacional; quando usar; core web vitals 2026; otimização de assets."
version: 2.0.0
category: devops
tools:
  mcp:
...
> Migrado deterministicamente de `skills/web-perf-seo/SKILL.md` (v1) pelo skill-migrator (ADR-004). Corpo original preservado íntegro em **Legacy Reference (v1)**.

## Triggering Criteria

- **Domínio:** DevOps & Operação (`devops`)
- **Resumo:** Otimiza Core Web Vitals (LCP, CLS, INP), assets, cache e SEO on-page (meta tags, structured data) com metas de Lighthouse.
- **Ativar quando:** Use ao criar páginas, otimizar performance ou auditar SEO.
- **Escopo canônico:** Web Performance & SEO — Manual Operacional
- **Seções do corpo original:** Quando usar · Core Web Vitals 2026 · Otimização de Assets · Estratégias de Cache · SEO On-Page
...
### Passo 1 — Manual denso de performance web e SEO para sistemas de produção.
...
### Passo 2 — Pule para frontend para padrões de componentes React/Tailwind; animation-web para anima...
...
### Passo 3 — O score de Performance é uma média ponderada (curva log-normal contra dados reais do HT...
...
### Passo 4 — Os pesos mudam entre versões do Lighthouse (o time do Chrome recalibra com base em pesq...
